...
@Component({
  ...
  selector: 'app-startup-service',
  templateUrl: './startup-service.component.html',
  styleUrls: ['./startup-service.component.css']
})
export class StartupServiceComponent implements OnInit {
  ...
  isServiceClosed = (service:Service) => {
    if(service.servStatus == "closed"){
      return true;
    }
    return false;
  };
